...
if __name__ == "__main__":
    ...
    # print(parsed)
    # parsed = urlparse("https://ics.uci.edu/~emilyo/teaching/info122w2014/samplecode/lecture8/FactoryMethod/bin/PizzaStore.class")
    # print(parsed)
    # print("True" if "ics.uci.edu" not in parsed.hostname else "False")
